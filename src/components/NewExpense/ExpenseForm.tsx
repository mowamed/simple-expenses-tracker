        ...
        <form onSubmit={submitHandler}>
            <div className="new-expense__controls">
                ...
                <div className="new-expense__control">
                    ...
                    <input value={amount} onChange={amountChangedHandler} type="number" min="0.1" step="0.1"/>
                </div>

                <div className="new-expense__control">
                    <label htmlFor="">Date</label>
                    <input value={date} onChange={dateChangedHandler} type="date" min="2019-01-01" max="2022-12-31"/>
                </div>
            </div>
